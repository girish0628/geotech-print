...
```
conda create --name geotech-print-env --clone arcgispro-py3
...
- User installs: `C:\Users\{username}\AppData\Local\ESRI\conda\envs\geotech-print-env\python.exe`
